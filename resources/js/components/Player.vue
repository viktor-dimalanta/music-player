...
<template>
  <div class="wrapper" id="app">
        ...
        <div class="player__top">
          <div class="player-cover">
            <transition-group :name="transitionName">
                <!-- <div class="player-cover__item" v-if="$index === currentTrackIndex" v-for="(track, $index) in tracks" :key="$index" v-bind:style="{ backgroundImage: 'url(' + currentTrack.cover + ')' }"  ></div> -->
                <div class="player-cover__item" v-bind:style="{ backgroundImage: 'url(' + currentTrack.cover + ')' }"  ></div>
            </transition-group>
          </div>
      ...
      <a href="https://github.com/viktor-dimalanta/music-player" target="_blank" class="github-btn">
        See on GitHub
      </a>
    </div>
  </div>
